      ...
      <div className="siteFooter__inner">
        <div className="siteFooter__grid">
          ...
          <div className="siteFooter__col">
            ...
            <ul className="siteFooter__list">
              <li><a className="siteFooter__link" href="/order-online">ORDER ONLINE</a></li>
          ...
          <div className="siteFooter__col">
            ...
            <ul className="siteFooter__list siteFooter__list--muted">
              <li className="siteFooter__text">Address</li>
              <li className="siteFooter__text">Number</li>
              <li className="siteFooter__text">Open/Close times</li>
            </ul>
